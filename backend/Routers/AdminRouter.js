...
router.put('/orders/update/:id' , AUTHORIZE_USER ,OrderController.update_a_order);
router.delete('/orders/delete/' ,AUTHORIZE_USER ,  OrderController.delete_order_items);
