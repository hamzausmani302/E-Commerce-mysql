...
ALTER TABLE ORDERSTATUS ADD CONSTRAINT FK_ORDERSTATUS_SHIPPER FOREIGN KEY(DELIVERY_PARTNER) REFERENCES SHIPPERS(SHIPPER_ID);
...
ALTER TABLE CATEGORY ADD CONSTRAINT FK_CATEGORY_CATEGORY FOREIGN KEY(PARENT_ID) REFERENCES CATEGORY(CATEGORY_ID);
 ALTER TABLE ORDERS_ITEMS ADD CONSTRAINT FK_ITEMS_ORDERS FOREIGN KEY(ORDER_ID) REFERENCES ORDERSTATUS(ORDER_ID);
